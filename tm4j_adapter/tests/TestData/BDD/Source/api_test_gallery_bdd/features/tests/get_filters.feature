...
Feature: We should be able to get user filters
  ...
  Scenario Outline: CST-T105_As doctor I want to to get the list of anonymized filters with assets
  ...
  Scenario Outline: CST-T106_As doctor I want to to get the list of nonanonymized filters with assets
    Given I access "gallery" api as "default_user"
